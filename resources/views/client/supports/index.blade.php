                    ...
                    <form class="space-y-5">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div class="flex flex-col gap-2">
                                ...
                                <input
                                    class="rounded-lg border-[#e6e3db] dark:border-white/10 bg-background-light dark:bg-white/5 focus:border-primary focus:ring-primary w-full px-4 py-3"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <select
                                    ...
                                    <option>Yêu cầu bảo hành</option>
                                    <option>Khác</option>
                                </select>
                            </div>
                        </div>
                        <div class="flex flex-col gap-2">
                            ...
                            <textarea
                                class="rounded-lg border-[#e6e3db] dark:border-white/10 bg-background-light dark:bg-white/5 focus:border-primary focus:ring-primary w-full px-4 py-3"
                                placeholder="Bạn cần chúng tôi hỗ trợ gì?" rows="5"></textarea>
                        </div>
                        <button
                            class="w-full md:w-auto min-w-[200px] h-14 bg-primary text-[#181611] font-bold text-lg rounded-xl hover:opacity-90 transition-all shadow-md shadow-primary/20 flex items-center justify-center gap-2"
                            type="button">
