...
@section('content')
    ...
    <head>
        ...
        <title>Liên hệ và Hỗ trợ Bee Phone</title>
...
">
    ...
    <body class="bg-background-light dark:bg-background-dark text-[#181611] dark:text-white font-display">
        <!-- Top Navigation Bar -->
        ...
        <main class="max-w-[1200px] mx-auto px-4 lg:px-10 py-10">
                ...
                <div class="px-4 py-3">
                    <label class="flex flex-col min-w-40 h-14 w-full shadow-lg rounded-xl overflow-hidden">
                        <div class="flex w-full flex-1 items-stretch rounded-xl h-full">
                            <div
                                class="text-[#8a8060] flex border-none bg-white dark:bg-white/5 items-center justify-center pl-5 border-r-0">
                                <span class="material-symbols-outlined">search</span>
                            </div>
                            <input
                                class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden text-[#181611] dark:text-white focus:outline-0 focus:ring-0 border-none bg-white dark:bg-white/5 h-full placeholder:text-[#8a8060] px-4 pl-3 text-lg font-normal leading-normal"
                                placeholder="Tìm kiếm câu hỏi thường gặp..." value="" />
                        </div>
                    </label>
                </div>
            </div>
            ...
            <section class="mb-20">
                <div class="flex items-center justify-center gap-2 mb-8">
                    ...
                    <h2 class="text-[#181611] dark:text-white text-2xl font-bold leading-tight tracking-[-0.015em]">Câu hỏi
                        thường gặp (FAQ)</h2>
                </div>
                <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
                    <details
                        class="flex flex-col rounded-xl border border-[#e6e3db] dark:border-white/10 bg-white dark:bg-white/5 px-5 py-4 group cursor-pointer hover:border-primary/50 transition-colors"
                        open="">
                        <summary class="flex items-center justify-between gap-6 py-1 list-none">
                            <div class="flex items-center gap-3">
                                <span class="material-symbols-outlined text-primary">local_shipping</span>
                                <p class="text-[#181611] dark:text-white text-base font-semibold leading-normal">Giao hàng
                                </p>
                            </div>
                            <span
                                class="material-symbols-outlined text-[#181611] dark:text-white group-open:rotate-180 transition-transform">expand_more</span>
                        </summary>
                        <p class="text-[#8a8060] dark:text-white/60 text-sm font-normal leading-relaxed pt-4">
                            Bee Phone hỗ trợ giao hàng hỏa tốc trong 2h tại Hà Nội và TP.HCM. Đối với các tỉnh thành khác,
                            thời gian nhận hàng từ 2-4 ngày làm việc. Chúng tôi miễn phí vận chuyển cho đơn hàng trên 2
                            triệu đồng.
                        </p>
                    </details>
                    <details
                        ...
                        <p class="text-[#8a8060] dark:text-white/60 text-sm font-normal leading-relaxed pt-4">
                            Quý khách có thể đổi trả sản phẩm trong vòng 30 ngày nếu phát sinh lỗi từ nhà sản xuất. Sản phẩm
                            phải còn nguyên hộp, phụ kiện và chưa qua sửa chữa bên ngoài.
                        </p>
                    </details>
                    <details
                        class="flex flex-col rounded-xl border border-[#e6e3db] dark:border-white/10 bg-white dark:bg-white/5 px-5 py-4 group cursor-pointer hover:border-primary/50 transition-colors">
                        <summary class="flex items-center justify-between gap-6 py-1 list-none">
                            <div class="flex items-center gap-3">
                                ...
                                <p class="text-[#181611] dark:text-white text-base font-semibold leading-normal">Bảo hành
                                </p>
                            </div>
                            <span
                                class="material-symbols-outlined text-[#181611] dark:text-white group-open:rotate-180 transition-transform">expand_more</span>
                        ...
                        <p class="text-[#8a8060] dark:text-white/60 text-sm font-normal leading-relaxed pt-4">
                            Mọi sản phẩm tại Bee Phone đều được hưởng chính sách bảo hành chính hãng 12 tháng. Bạn có thể
                            tra cứu bảo hành điện tử qua số IMEI/Serial Number ngay trên website.
                        </p>
                    </details>
                    <details
                        class="flex flex-col rounded-xl border border-[#e6e3db] dark:border-white/10 bg-white dark:bg-white/5 px-5 py-4 group cursor-pointer hover:border-primary/50 transition-colors">
                        <summary class="flex items-center justify-between gap-6 py-1 list-none">
                            <div class="flex items-center gap-3">
                                ...
                                <p class="text-[#181611] dark:text-white text-base font-semibold leading-normal">Thanh toán
                                </p>
                            </div>
                            <span
                                class="material-symbols-outlined text-[#181611] dark:text-white group-open:rotate-180 transition-transform">expand_more</span>
                        ...
                        <p class="text-[#8a8060] dark:text-white/60 text-sm font-normal leading-relaxed pt-4">
                            Chúng tôi chấp nhận thanh toán qua thẻ VISA/MasterCard, chuyển khoản, ví MoMo, ZaloPay và hỗ trợ
                            trả góp 0% lãi suất qua thẻ tín dụng hoặc các công ty tài chính.
                        </p>
                    </details>
                </div>
            </section>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
                ...
                <div
                    class="lg:col-span-3 bg-white dark:bg-white/5 rounded-2xl border border-[#e6e3db] dark:border-white/10 p-8 shadow-sm">
                    <h3 class="text-2xl font-bold mb-6 flex items-center gap-3">
                        <span class="material-symbols-outlined text-primary">mail</span>
                        Gửi yêu cầu hỗ trợ
                    </h3>
                    <form action="{{ route('client.tickets.store') }}" method="POST" class="space-y-5">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div class="flex flex-col gap-2">
                                <label class="text-sm font-semibold">Họ và tên</label>
                                <input name="customer_name"
                                    class="rounded-lg border-[#e6e3db] dark:border-white/10 bg-background-light dark:bg-white/5 w-full px-4 py-3"
                                    placeholder="Nhập họ tên của bạn" type="text" value="{{ old('customer_name') }}"
                                    required>
                            </div>
                            <div class="flex flex-col gap-2">
                                ...
                                <input name="customer_email" type="email"
                                    class="rounded-lg border-[#e6e3db] dark:border-white/10 bg-background-light dark:bg-white/5 w-full px-4 py-3"
                                    placeholder="example@email.com" value="{{ old('customer_email') }}" required>
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div class="flex flex-col gap-2">
                                ...
                                <input name="customer_phone" type="tel"
                                    class="rounded-lg border-[#e6e3db] dark:border-white/10 bg-background-light dark:bg-white/5 w-full px-4 py-3"
                                    placeholder="0xxx xxx xxx" value="{{ old('customer_phone') }}">
                            </div>
                            <div class="flex flex-col gap-2">
                                <label class="text-sm font-semibold">Tiêu đề</label>
                                <select name="title"
                                    class="rounded-lg border-[#e6e3db] dark:border-white/10 bg-background-light dark:bg-white/5 w-full px-4 py-3">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <textarea name="description" rows="5"
                                class="rounded-lg border-[#e6e3db] dark:border-white/10 bg-background-light dark:bg-white/5 w-full px-4 py-3"
                                placeholder="Bạn cần chúng tôi hỗ trợ gì?">{{ old('description') }}</textarea>
                        </div>
                        <button type="submit"
                            class="w-full md:w-auto min-w-[200px] h-14 bg-primary text-[#181611] font-bold text-lg rounded-xl hover:opacity-90">
                            Gửi yêu cầu
                        </button>
                    </form>
                </div>
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div
                        class="bg-white dark:bg-white/5 rounded-2xl border border-[#e6e3db] dark:border-white/10 p-8 shadow-sm">
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <p
                                        class="text-xs font-semibold uppercase text-[#8a8060] dark:text-white/40 tracking-wider">
                                        Hotline 24/7</p>
                    ...
                    <div class="bg-[#e6e3db] dark:bg-white/10 rounded-2xl h-64 w-full overflow-hidden relative group"
                        data-location="Hanoi, Vietnam" style="">
                        <div class="absolute inset-0 bg-cover bg-center transition-transform duration-500 group-hover:scale-110"
                            data-alt="Google Maps location preview of Bee Phone store"
                        ...
                        <div class="absolute inset-0 bg-black/10 flex items-center justify-center">
                            <div
                                class="bg-white dark:bg-background-dark px-4 py-2 rounded-lg shadow-xl flex items-center gap-2">
        ...
        <footer class="bg-white dark:bg-white/5 border-t border-[#f5f3f0] dark:border-white/10 mt-20">
            <div
                class="max-w-[1200px] mx-auto px-4 lg:px-10 py-12 flex flex-col md:flex-row justify-between items-center gap-8">
                ...
                <div class="flex gap-6">
                    <a class="text-[#8a8060] dark:text-white/40 hover:text-primary transition-colors"
                        href="#">Privacy Policy</a>
                    <a class="text-[#8a8060] dark:text-white/40 hover:text-primary transition-colors" href="#">Terms
                        of Service</a>
                </div>
            </div>
        </footer>
...
<div class="container mx-auto py-10 max-w-xl">
    ...
    <h2 class="text-2xl font-bold mb-6">Gửi yêu cầu hỗ trợ</h2>
    ...
    <form action="{{ route('client.tickets.store') }}" method="POST" class="space-y-4">
        @csrf
