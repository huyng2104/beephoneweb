                        ...
                        <div class="p-6 space-y-4">
                            <div class="flex flex-wrap items-center justify-between gap-4">
                                <div class="flex flex-1 min-w-[300px] max-w-md">
                                    <form method="GET" action="{{ route('admin.post-categories.index') }}"
                                        class="flex flex-1 min-w-[300px] max-w-md">
                                    ...
                                    <thead>
                                        <tr
                                            ...
                                            {{-- <th class="py-4 px-2 font-bold text-xs uppercase tracking-wider text-center">
                                                Hiển thị</th> --}}
                                            <th class="py-4 px-2 font-bold text-xs uppercase tracking-wider text-right">
                                                Thao
                                                tác</th>
                                        </tr>
                                    </thead>
