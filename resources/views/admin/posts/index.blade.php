...
@section('content')
    ...
    <head>
        ...
        <title>Quản lý bài viết Bee Phone</title>
...
">
    ...
    <body class="bg-background-light dark:bg-background-dark min-h-screen">
        <div class="layout-container flex flex-col">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-black text-[#181611] dark:text-white">1,248</p>
                            </div>
                        </div>
                        <div
                            class="bg-white dark:bg-[#2c2818] p-5 rounded-xl border border-[#e6e3db] dark:border-[#3d3a30] shadow-sm flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-black text-[#181611] dark:text-white">45.2k</p>
                            </div>
                        </div>
                        <div
                            class="bg-white dark:bg-[#2c2818] p-5 rounded-xl border border-[#e6e3db] dark:border-[#3d3a30] shadow-sm flex items-center gap-4">
            ...
            <!-- Sidebar Floating Action (Optional Mobile or Quick Access) -->
            <div class="fixed bottom-8 right-8">
                <button
                    class="w-14 h-14 bg-primary rounded-full shadow-lg flex items-center justify-center text-[#181611] hover:scale-110 transition-transform">
                    <span class="material-symbols-outlined font-bold text-3xl">chat_bubble</span>
                </button>
            </div>
        </div>
    </body>
