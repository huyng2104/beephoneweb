...
class CheckoutController extends Controller
{
    ...
    public function process(Request $request)
    {
        ...
        $request->validate([
            ...
            'ghn_district_id.required' => 'Hệ thống chưa nhận diện được Quận/Huyện giao hàng. Vui lòng chọn lại!',
            'ghn_ward_code.required'   => 'Hệ thống chưa nhận diện được Phường/Xã giao hàng. Vui lòng chọn lại!',
